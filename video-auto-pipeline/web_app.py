...
try:
    ...
    app.register_blueprint(content_fetch_bp)
    logger.info("内容采集路由已注册")
except ImportError as e:
    logger.warning(f"内容采集路由不可用: {e}")
except Exception as e:
    logger.error(f"注册内容采集路由失败: {e}")
...
try:
    ...
    logger.warning(f"监控路由不可用: {e}")
except Exception as e:
    logger.error(f"注册监控路由失败: {e}")

# 导入任务路由
try:
    from routes.task_routes import task_bp, init_task_manager
    ...
    logger.warning(f"任务路由不可用: {e}")
except Exception as e:
    logger.error(f"注册任务路由失败: {e}")
...
try:
    ...
    logger.warning(f"配置路由不可用: {e}")
except Exception as e:
    logger.error(f"注册配置路由失败: {e}")
...
try:
    ...
    logger.warning(f"分析路由不可用: {e}")
except Exception as e:
    logger.error(f"注册分析路由失败: {e}")
...
try:
    ...
    logger.warning(f"账号路由不可用: {e}")
except Exception as e:
    logger.error(f"注册账号路由失败: {e}")
...
try:
    ...
    logger.warning(f"用户路由不可用: {e}")
except Exception as e:
    logger.error(f"注册用户路由失败: {e}")
...
try:
    ...
    logger.warning(f"日志路由不可用: {e}")
except Exception as e:
    logger.error(f"注册日志路由失败: {e}")
...
try:
    ...
    logger.warning(f"视频路由不可用: {e}")
except Exception as e:
    logger.error(f"注册视频路由失败: {e}")
...
def content():
    ...
    try:
        # 获取统计数据
        try:
            from api_content_simple import get_content_stats
        ...
        return render_template('content.html', stats=stats)
    except Exception as e:
        logger.error(f"渲染内容页面失败: {e}")
        return f"页面加载失败: {e}", 500
